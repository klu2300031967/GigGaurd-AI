...
## What we have built (Current Progress)

We have developed a working frontend prototype to demonstrate the idea:

- Login system  
- Dashboard interface  
- Income input system (expected vs actual earnings)  
- Payout decision logic  
- Clean and modern UI with premium theme  

The system currently simulates real-world scenarios and shows how payouts are calculated based on income loss.
...
## Explination
https://youtu.be/IYar2bWeiUo?si=mzcVNZ9Bs6XE-vU_
